...
def execute(self, inputs, outputs, gvm):
    ...
    self.logger.info("Saywer move (traj) to put garbage on the robot!")
    ...
    if testMode:
        ...
        callArguments = ['rosservice','call','/sawyer_move', 'traj_gbgstore']
        
        rospy.wait_for_service('/sawyer_move')
        sawyer_grasp = rospy.ServiceProxy('sawyer_move', MoveSawyer)
        outputData = str(sawyer_grasp('traj_gbgstore', 0))
